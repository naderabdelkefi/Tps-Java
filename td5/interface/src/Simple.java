...
class Simple {
  ...
  static public void main (String[] args) {
    Transport serenity = tec.Fabrique.faireAutobus (1, 2);

    Usager kaylee = tec.Fabrique.fairePassagerStandard ("Kaylee", 4);
    Usager jayne = tec.Fabrique.fairePassagerStandard ("Jayne", 4);
    Usager inara = tec.Fabrique.fairePassagerStandard ("Inara", 5);
