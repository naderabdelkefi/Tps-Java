...
class Position {
  ...
  private static final Position positionAssis = new Position();
  private static final Position positionDehors = new Position();
  private static final Position positionDebout = new Position();
